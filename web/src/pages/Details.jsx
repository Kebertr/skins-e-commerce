    ...
    <div>
        ...
        <p>Price: {skin.skin_value} Cash-Coins</p>
          <input
            ...
            required
          /> 
        <button onClick={() => addBasket(skin, sessionData, document.getElementById("quantity").value)}>Add to your Basket</button>
          <input
            id="review"
            type="text"
            name="review"
          ...
          <input
            ...
            required
          />
          <button onClick={() => makeReview(skin, sessionData, document.getElementById("review").value, document.getElementById("grade").value)}>Grade</button>
    </div>
    <div>
...
function makeReview(skin, sessionData, review, grade){
  ...
  var productId = skin.id;
  axios
      .post("http://localhost:3000/makeReview", {review, grade, userId, productId})
      .then((response) => {
        console.log("Data sent successfully:", response.data);
